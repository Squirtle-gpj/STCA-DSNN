...
__global__ void t_v_alter_multispike( double *output, double *u, int *t_alter, double *direction,const int *desired,const double * input, const int T_size, const int Numcurlayer,  const double decay1, const double decay2, const double threshold, const double subthreshold)
{
