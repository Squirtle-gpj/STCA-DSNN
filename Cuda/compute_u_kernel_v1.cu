...
__global__ void compute_u_kernel( double *output, double *u, const double * input, const int T_size, const int Numcurlayer,  const double decay1, const double decay2, const double threshold)
{
